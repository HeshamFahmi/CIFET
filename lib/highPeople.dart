...
class _HighPeopleState extends State<HighPeople> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        appBar: customAppBar("اللجنه العليا", context, false),
          ...
          child: Container(
            ...
            builder: (BuildContext context, int index) {
              return PhotoViewGalleryPageOptions(
                imageProvider: NetworkImage(highPeopleImages[index]),
                initialScale: PhotoViewComputedScale.contained,
                heroAttributes:
                    PhotoViewHeroAttributes(tag: highPeopleImages[index]),
              );
            },
            itemCount: highPeopleImages.length,
