...
class _WatchesState extends State<Watches> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        appBar: customAppBar("لجنــة المشاهــدة", context, false),
          ...
          child: Container(
            ...
            builder: (BuildContext context, int index) {
              return PhotoViewGalleryPageOptions(
                imageProvider: NetworkImage(watchesImages[index]),
                initialScale: PhotoViewComputedScale.contained,
                heroAttributes:
                    PhotoViewHeroAttributes(tag: watchesImages[index]),
              );
            },
            itemCount: watchesImages.length,
